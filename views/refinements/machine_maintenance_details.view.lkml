...
##### MEASURES
  ...
  measure: mmt1_slo_average_score_base {
    ...
    link: {
      ...
      url: "/dashboards/three_pdc_metrics_poc::3pdc_machine_maintenance?Region={{ _filters['three_pdc_metrics_demo.region']| url_encode }}&Metro={{ _filters['three_pdc_metrics_demo.metro']| url_encode }}&Duration%20Type={{ _filters['three_pdc_metrics_demo.param_duration_type']| url_encode }}&Duration%20Date={{ _filters['three_pdc_metrics_demo.p_duration_date']| url_encode }}&Metro%20Tier=Tier 1"
    }
    value_format: "0.00\%"
