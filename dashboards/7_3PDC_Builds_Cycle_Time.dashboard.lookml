---
- dashboard: 3pdc_builds_cycle_time
  title: 3PDC Builds Cycle Time
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: aSSvPQAoh5sYHRSEtcllie
  elements:
  - title: Metric Summary
    ...
    listen:
      ...
      Is Marine or Payload (Yes / No): _bct_detail_summary_data.is_marine_or_payload
    row: 1
    col: 0
    width: 24
    height: 6
  - name: Build Cycle Time Details
    type: text
    title_text: Build Cycle Time Details
    subtitle_text: ''
    body_text: ''
    row: 7
    col: 0
  ...
  - title: SLO Score
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.bct_target, _bct_detail_summary_data.bct_miss_count,
      _bct_detail_summary_data.bct_met_count, _bct_detail_summary_data.bct_total_count,
      three_pdc_metrics_demo.bct_slo_score]
    filters: {}
  ...
  - title: Slip Details
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, _bct_detail_summary_data.viewpoint_link,
      _bct_detail_summary_data.phase_id, three_pdc_metrics_demo.calendar_date, _bct_detail_summary_data.slo_target_date,
      _bct_detail_summary_data.slip_code_tier_1, _bct_detail_summary_data.slip_code_tier_2,
      _bct_detail_summary_data.root_cause_owner, _bct_detail_summary_data.process_model,
      _bct_detail_summary_data.comment, _bct_detail_summary_data.slo_slip_type]
    filters:
      _bct_detail_summary_data.slo_slip_type: Standard Slip
    sorts: [three_pdc_metrics_demo.region]
    limit: 500
    column_limit: 50
    show_view_names: false
  ...
  - title: Trend View
    ...
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.p_duration_date,
      three_pdc_metrics_demo.bct_target, three_pdc_metrics_demo.bct_slo_score]
    filters: {}
    sorts: [three_pdc_metrics_demo.bct_target desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: three_pdc_metrics_demo.bct_slo_score,
            id: three_pdc_metrics_demo.bct_slo_score, name: 'Builds Cycle Time (Target:
              95%)'}, {axisId: three_pdc_metrics_demo.bct_target, id: three_pdc_metrics_demo.bct_target,
            name: Target}], showLabels: true, showValues: true, unpinAxis: false,
    ...
    hide_legend: false
    series_types:
      three_pdc_metrics_demo.bct_target: scatter
    series_colors:
    ...
    series_labels:
      ...
      three_pdc_metrics_demo.bct_slo_score: SLO Score
    series_point_styles:
      three_pdc_metrics_demo.bct_target: auto
    defaults_version: 1
    hidden_pivots: {}
    listen:
      Region: three_pdc_metrics_demo.region
  ...
  - name: Is Marine or Payload (Yes / No)
    title: Is Marine or Payload (Yes / No)
    type: field_filter
    default_value: 'No'
    allow_multiple_values: true
    required: false
    ...
    explore: three_pdc_metrics_demo
    listens_to_filters: []
    field: _bct_detail_summary_data.is_marine_or_payload
