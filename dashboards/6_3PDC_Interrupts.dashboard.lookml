---
- dashboard: 3pdc_interrupts
  title: 3PDC Interrupts
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: dV6eW27UMRKROKrzzsUftl
  elements:
  - title: Metric Summary
    ...
    width: 24
    height: 6
  - name: Interrupts Details
    type: text
    title_text: Interrupts Details
    subtitle_text: ''
    body_text: ''
    row: 7
    col: 0
  ...
  - title: SLO Score
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.irpt_target, three_pdc_metrics_demo.irpt_slo_score,
      three_pdc_metrics_demo.irpt_total_bugs, three_pdc_metrics_demo.irpt_slo_met]
    filters: {}
  ...
  - title: Active Bugs
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, _irpt_active_bugs_detail_data.bug_id,
      _irpt_active_bugs_detail_data.priority, _irpt_active_bugs_detail_data.bug_type,
      _irpt_active_bugs_detail_data.title, _irpt_active_bugs_detail_data.assignee,
      _irpt_active_bugs_detail_data.manager_name, _irpt_active_bugs_detail_data.assignment_slo,
      _irpt_active_bugs_detail_data.response_slo, _irpt_active_bugs_detail_data.closure_slo,
      _irpt_active_bugs_detail_data.bug_status]
    sorts: [three_pdc_metrics_demo.region]
    limit: 500
    column_limit: 50
    show_view_names: false
  ...
  - title: Trend View
    ...
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.p_duration_date,
      three_pdc_metrics_demo.irpt_slo_score, three_pdc_metrics_demo.irpt_target]
    filters: {}
    sorts: [three_pdc_metrics_demo.irpt_slo_score desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: three_pdc_metrics_demo.irpt_target,
            id: three_pdc_metrics_demo.irpt_target, name: Target}, {axisId: three_pdc_metrics_demo.irpt_slo_score,
            id: three_pdc_metrics_demo.irpt_slo_score, name: SLO Score}], showLabels: true,
    ...
    hide_legend: false
    series_types:
      three_pdc_metrics_demo.irpt_target: scatter
    series_colors:
