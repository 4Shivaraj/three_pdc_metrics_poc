---
- dashboard: 3pdc_machine_maintenance
  title: 3PDC Machine Maintenance
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: LGLW9TgF6BOG4SbLIX8ss9
  elements:
  ...
  - title: SLO Score
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, _mm_summary_data.target, _mm_summary_data.slo_average_score,
      _mm_summary_data.ooslo_average_score]
    filters: {}
  ...
  - title: Untitled
    ...
    width: 8
    height: 1
  - title: Parts Unavailable Slips
    name: Parts Unavailable Slips
    model: three_pdc_metrics_poc
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, three_pdc_metrics_demo.calendar_date,
      _mm_detail_data.slip_source, _mm_detail_data.slip_category, _mm_detail_data.slip_type,
      _mm_detail_data.gpn, _mm_detail_data.gpn_part_name, _mm_detail_data.aging, _mm_detail_data.metro_tier]
    filters:
      _mm_detail_data.slip_source: Parts Unavialable
    sorts: [three_pdc_metrics_demo.region]
    limit: 500
    column_limit: 50
    show_view_names: false
  ...
  - title: Trend View
    ...
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.p_duration_date,
      _mm_summary_data.slo_average_score, _mm_summary_data.ooslo_average_score]
    filters: {}
    sorts: [_mm_summary_data.slo_average_score desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: _mm_summary_data.slo_average_score,
            ...
            id: _mm_summary_data.ooslo_average_score, name: Out of SLO Average Score}],
        showLabels: true, showValues: true, unpinAxis: false, tickDensity: custom,
        tickDensityCustom: 24, type: linear}]
    x_axis_zoom: true
    y_axis_zoom: false
    ...
    width: 13
    height: 6
  - title: Software Slips
    name: Software Slips
    model: three_pdc_metrics_poc
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, _mm_detail_data.slip_source,
      _mm_detail_data.slip_category, _mm_detail_data.slip_type, _mm_detail_data.aging,
      _mm_detail_data.metro_tier, _mm_detail_data.bug_id]
    filters:
      _mm_detail_data.slip_source: Software
    sorts: [three_pdc_metrics_demo.region]
    limit: 500
    column_limit: 50
    show_view_names: false
    ...
    minimum_column_width: 75
    defaults_version: 1
    column_order: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, three_pdc_metrics_demo.calendar_date,
      _mm_detail_data.slip_source, _mm_detail_data.slip_category, _mm_detail_data.slip_type,
      _mm_detail_data.bug_id, _mm_detail_data.metro_tier, _mm_detail_data.aging]
    listen:
      Region: three_pdc_metrics_demo.region
      Metro: three_pdc_metrics_demo.metro
      Duration Date: three_pdc_metrics_demo.p_duration_date
  ...
  - title: Not Set Slips
    ...
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, three_pdc_metrics_demo.calendar_date,
      _mm_detail_data.slip_source, _mm_detail_data.slip_category, _mm_detail_data.slip_type,
      _mm_detail_data.aging, _mm_detail_data.metro_tier, _mm_detail_data.bug_id, _mm_detail_data.pool]
    filters:
      _mm_detail_data.slip_source: Not Set
    sorts: [three_pdc_metrics_demo.region]
    limit: 500
    column_limit: 50
    show_view_names: false
    ...
    column_order: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, three_pdc_metrics_demo.calendar_date,
      _mm_detail_data.slip_source, _mm_detail_data.slip_category, _mm_detail_data.slip_type,
      _mm_detail_data.pool, _mm_detail_data.bug_id, _mm_detail_data.aging, _mm_detail_data.metro_tier]
    listen:
      Region: three_pdc_metrics_demo.region
      Metro: three_pdc_metrics_demo.metro
      Duration Date: three_pdc_metrics_demo.p_duration_date
