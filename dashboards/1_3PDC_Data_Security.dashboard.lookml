...
- dashboard: 3pdc_data_security
  ...
  description: ''
  preferred_slug: Age3PHz32P0gkyAtYnr8cA
  elements:
  ...
  - title: SLO Score
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.sdd_hwops_violations,
      three_pdc_metrics_demo.sdd_processed_count, three_pdc_metrics_demo.sdd_slo_score_base]
    filters: {}
  ...
  - title: Slip Causes
    ...
    explore: three_pdc_metrics_demo
    type: looker_grid
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.metro, three_pdc_metrics_demo.p_duration_date,
      _ds_detail_data.slip_details]
    filters: {}
    sorts: [three_pdc_metrics_demo.region]
    limit: 500
    column_limit: 50
  ...
  - title: Trend View
    ...
    fields: [three_pdc_metrics_demo.region, three_pdc_metrics_demo.p_duration_date,
      three_pdc_metrics_demo.sdd_slo_score_base, three_pdc_metrics_demo.ds_target]
    filters: {}
    sorts: [three_pdc_metrics_demo.sdd_slo_score_base desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: three_pdc_metrics_demo.sdd_slo_score_base,
            id: three_pdc_metrics_demo.sdd_slo_score_base, name: SLO Score}, {axisId: three_pdc_metrics_demo.ds_target,
            id: three_pdc_metrics_demo.ds_target, name: Target}], showLabels: true,
    ...
    hide_legend: false
    series_types:
      three_pdc_metrics_demo.ds_target: scatter
    series_colors:
      three_pdc_metrics_demo.ds_target: "#EA4335"
    series_labels:
      three_pdc_metrics_demo.sdd_slo_score_base: SLO Score
    series_point_styles:
      three_pdc_metrics_demo.ds_target: auto
    defaults_version: 1
    listen:
      Region: three_pdc_metrics_demo.region
      Metro: three_pdc_metrics_demo.metro
